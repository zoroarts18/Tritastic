            ...
            if(CS.GameMode == 2)
            {
                ...
                if (Player.GetComponent<FollowFingerScript>().isDead == false)
                {
                    ...
                    switch (PlayerPrefs.GetInt("skinSelected", 0))
                    {
                        ...
                        //EventSkins:
                        case 4:
                            Instantiate(HalloweenDeathVFX, Player.transform.position, Quaternion.identity);

                            break;
                        case 5:
                            Instantiate(WeihnachtsDeathVFX, Player.transform.position, Quaternion.identity);

                            break;
                        case 6:
                            Instantiate(SilvesterDeathVFX, Player.transform.position, Quaternion.identity);
